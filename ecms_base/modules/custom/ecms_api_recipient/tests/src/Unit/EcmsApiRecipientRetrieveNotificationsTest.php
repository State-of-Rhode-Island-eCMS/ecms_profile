...
class EcmsApiRecipientRetrieveNotificationsTest extends UnitTestCase {
  ...
  /**
   * The json object string to test with.
   */
  ...
  /**
   * Mock of the ecms_api_recipient.settings.
   *
  ...
  /**
   * Mock of the NotificationCreationQueueWorker queue.
   *
  ...
  /**
   * Mock of the NotificationPagerQueueWorker queue.
   *
   * @var \Drupal\Core\Queue\QueueInterface|\PHPUnit\Framework\MockObject\MockObject
   */
  private $pagerQueue;
  ...
  private function getTestClass(): EcmsApiRecipientRetrieveNotifications {
    ...
    $queueFactory->expects($this->exactly(2))
      ...
      ->will($this->returnValueMap([
        ['ecms_api_recipient_notification_creation_queue', $this->notificationQueue],
        ['ecms_api_recipient_notification_pager_queue', $this->pagerQueue]
      ]));
