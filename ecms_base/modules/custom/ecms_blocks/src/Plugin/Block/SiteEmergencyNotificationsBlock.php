 ...
 *
 * @Block(
 *   id = "ecms_site_emergency_notifications",
 *   admin_label = @Translation("Site Emergency Notifications"),
 *   context_definitions = {
 *     "node" = @ContextDefinition("entity:node", label = @Translation("Node"))
 *   }
 * )
 */
class SiteEmergencyNotificationsBlock extends BlockBase implements ContainerFactoryPluginInterface {
  ...
  public function build(): array {
    ...
    // Query all emergency notifications.
    ...
    $query->condition('type', 'emergency_notification')
      ...
      ->sort('field_emergency_weight', "DESC");
  ...
  public function getCacheTags(): array {
    // We want to rebuild when emergency notifications change.
    return Cache::mergeTags(parent::getCacheTags(), ['node_list:emergency_notification']);
  }
