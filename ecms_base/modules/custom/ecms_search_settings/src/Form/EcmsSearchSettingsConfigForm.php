...
class EcmsSearchSettingsConfigForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state): array {
    ...
    $form['excerpt_length'] = [
      ...
      '#description' => $this->t(
        'Set the length of the excerpt generated by the Highlight processor of '
        . 'Search API index, to handle search results with long text. Defaults to 256.'
      ),
      '#type' => 'textfield',
    ...
    $form['character_limit'] = [
      ...
      '#description' => $this->t(
        'Set the limit of characters in search results with long text, '
        . 'truncating the excerpt before rendering it. Defaults to 190.'
      ),
      '#type' => 'textfield',
